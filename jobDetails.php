            ...
            <div class="container glassmorphism">
              <div class="banner-headline-text-part">
                <div class="profile-container">
                  <img src="/Job-Portal-Project-PHP-MySql-CSS/assets/images/<?php echo $row1['profile_pic'] ?>" alt="">
                </div>
      ...
      <div class="company-details-page-content">
        <div class="company-details-page-content-left-side">
          <div class="image-container">
            <img src="/Job-Portal-Project-PHP-MySql-CSS/assets/images/aboutJob.jpg" alt="">
          </div>
              ...
              <div class="apply-save-box">
                ...
                if (isset($_SESSION['role_id']) && $_SESSION['role_id'] == 1) :  ?>
                  ...
                  ?>
                    ...
                    <?php else : ?>
                      <a href="/Job-Portal-Project-PHP-MySql-CSS/process/applyJob.php?key=<?php echo md5($job_id) . '&id=' . $job_id . '&cid=' . $company_id ?>" class="btn btn-secondary-form">Apply Job<i class="utf-verified-badge"></i></a>
                    <?php endif; ?>
                  <?php
                  endif; ?>
                  <?php
                  ...
                  <?php else : ?>
                    <a href="/Job-Portal-Project-PHP-MySql-CSS/process/saveJob.php?key=<?php echo md5($job_id)  . "&id=" . $job_id  ?>" class="btn btn-secondary-form">Save Job<i class="utf-verified-badge"></i></a>
                <?php endif;
                endif; ?>
              </div>
            </div>
