            ...
            <div class="container glassmorphism">
              <div class="banner-headline-text-part">
                <div class="profile-container">
                  <img src="/Job-Portal-Project-PHP-MySql-CSS/assets/images/<?php echo $row['profile_pic'] ?>" alt="">
                </div>
        ...
        <div class="company-details-page-content-left-side">
          <div class="company-details-page-content-left-side-about">
            ...
            <div class="image-container">
              <img src="/Job-Portal-Project-PHP-MySql-CSS/assets/images/aboutCompany.jpg" alt="">
            </div>
          ...
          <div class="company-details-page-content-left-side-jobpost">
            ...
            ?>
              <a href="/Job-Portal-Project-PHP-MySql-CSS/jobDetails.php?key=<?php echo $hash . '&id=' . $job_id ?>" class="job-item-container">
                <div class="profile-container">
                  <img src="/Job-Portal-Project-PHP-MySql-CSS/assets/images/<?php echo $profile_pic['profile_pic'] ?>" alt="">
                </div>
                <div class="job-info-container">
                ...
                <div class="review-item">
                  <div class="review-item-profile-container">
                    ...
                    if ($profile_pic !== null && isset($profile_pic['profile_pic'])) {
                      echo '<img  src="/Job-Portal-Project-PHP-MySql-CSS/assets/images/' . $profile_pic['profile_pic'] . '" alt="Profile Picture">';
                    } else {
                      echo "<img src='/Job-Portal-Project-PHP-MySql-CSS/assets/images/user.png' alt='Default Profile Picture'>";
                    }
                    ?>
