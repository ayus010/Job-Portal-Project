...
if (isset($_POST['changeResume'])) {
  ...
  if ($resume != '') {
    if (move_uploaded_file($_FILES['resume']['tmp_name'], '/Job-Portal-Project-PHP-MySql-CSS/assets/resume/' . $filename)) {
...
header('location: /Job-Portal-Project-PHP-MySql-CSS/dashboard/myresume.php');
exit();
