  ...
  <div class="dashboard-container">
    ...
    <div class="all-jobs-container">
      <div class="headline headline-container">
        <h3>All Companies</h3>
        <a href="/Job-Portal-Project-PHP-MySql-CSS/ReportGeneration/Admin/report-for-companies.php" class="btn"><i class="fa-solid fa-download"></i> Report</a>
      </div>
      <div>
        <table>
          <thead>
            ...
            while ($row = $query->fetch_assoc()) {
              ...
              echo "
                              <tr>
                                ...
                                <a class='btn btn-optional' href='/Job-Portal-Project-PHP-MySql-CSS/companyDetails.php?key=" . $hash . "&id=" . $company_id . "'>View</a>
                                <a href='/Job-Portal-Project-PHP-MySql-CSS/process/deleteCompany.php?key=" . $hash . "&id=" . $company_id . "&page=admin-control' class='btn btn-optional'>Remove </a> 
                                </td>
                                </tr>";
              $i++;
            }
