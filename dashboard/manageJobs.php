...
<body>
  ...
  <div class="dashboard-container">
    ...
    <div class="manage-job-content-container">
      ...
      if (!$id_company) {
        echo "<p style='color:red;'>Error: Company ID not found. Please login as a company user.</p>";
        exit();
      }
          ...
          <div class="job-info-container">
            <div class="job-info-upper-area">
              ...
              <div class="activity-container">
                <a href="/Job-Portal-Project-PHP-MySql-CSS/jobDetails.php?key=<?php echo $hash . '&id=' . $id_jobpost ?>"><i class="fa-solid fa-eye"></i></a>
                <a href="/Job-Portal-Project-PHP-MySql-CSS/dashboard/editJob.php?key=<?php echo $hash . '&id=' . $id_jobpost ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                <a href="/Job-Portal-Project-PHP-MySql-CSS/process/deleteJobs.php?key=<?php echo $hash . '&id=' . $id_jobpost ?>"><i class="fa-solid fa-trash"></i></a>
              </div>
            </div>
