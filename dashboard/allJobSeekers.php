  ...
  <div class="dashboard-container">
    ...
    <div class="all-jobs-container">
      <div class="headline headline-container">
        ...
        <a href="/Job-Portal-Project-PHP-MySql-CSS/ReportGeneration/Admin/report-for-jobseekers.php" class="btn"><i class="fa-solid fa-download"></i> Report</a>
      </div>
      <div>
        <table>
          <thead>
          ...
          <tbody>
            ...
            while ($row = $query->fetch_assoc()) {
              ...
              "<tr>
            <td>" . $i . "</td>
            <td><img height='50' width='50' src='/Job-Portal-Project-PHP-MySql-CSS/assets/images/" . $row['profile_pic'] . "'></td>
            <td>" . $row['fullname'] . "</td>
            ...
            <a href='/Job-Portal-Project-PHP-MySql-CSS/process/deleteUsers.php?key=" . $hash . "&id=" . $id_user . "&page=delete-jobseekers' class='btn btn-optional'>Remove</a> 
            </td>
            </tr>";
              $i++;
            }
