  ...
  <div class="dashboard-container">
    ...
    <div class="all-jobs-container">
      <div class="headline headline-container">
        <h3>All Job Posts</h3>
        <a href="/Job-Portal-Project-PHP-MySql-CSS/ReportGeneration/Admin/report-for-jobposts.php" class="btn"><i class="fa-solid fa-download"></i> Report</a>
      </div>
      <div>
        <table>
          <thead>
            ...
            while ($row = $query->fetch_assoc()) {
              ...
              echo "
                              <tr>
                                ...
                                <td>" . $city_id[0] . "</td>
                                <td>" . $company[0] . "</td>
                                <td class='action-button' ><a class='btn btn-optional' href='/Job-Portal-Project-PHP-MySql-CSS/jobDetails.php?key=" . $hash . "&id=" . $job_id . "'>View</a>
                                <a href='/Job-Portal-Project-PHP-MySql-CSS/process/deleteJobs.php?key=" . $hash . "&id=" . $job_id . "&page=admin-control' class='btn btn-optional'>Remove </a> 
                                </td>
                                </tr>";
              $i++;
            }
