          ...
          <div class="edit-profile-content-container-left-side">
            ...
            <div class="change-details-container">
              <div class="change-image-container">
                ...
                ?>
                  <img class="profile-pic" src="/Job-Portal-Project-PHP-MySql-CSS/assets/images/<?php echo $row['profile_pic'] ?>" alt="" />
                <?php else : ?>
                  <img class="profile-pic" src="/Job-Portal-Project-PHP-MySql-CSS/assets/images/user.png" alt="" />
                <?php endif; ?>
              </div>
              <form method="post" class="change-image-form" action="/Job-Portal-Project-PHP-MySql-CSS/process/changePic.php" enctype="multipart/form-data">
            ...
            <div class="edit-details-form">
              <form action="/Job-Portal-Project-PHP-MySql-CSS/process/changeProfile.php" method="post">
          ...
          <div class="edit-profile-content-container-right-side">
            ...
            <div class="password-container">
              ...
              <div class="change-password-container">
                <form method="post" action="/Job-Portal-Project-PHP-MySql-CSS/process/changePassword.php">
                  <div class="input-group">
            ...
            <div class="deactivate-container">
              ...
              <div class="deactivate-button-container">
                <form action="/Job-Portal-Project-PHP-MySql-CSS/process/deactivate.php" method="post">
                  <div class="button-container">
